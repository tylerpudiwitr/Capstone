...
export default state => html`
  ...
  <div id="about">
    <h5>
      In the future we plan on creating a system that will allow Artists and
      Producers to connect with each other directly on our app. This will help
      Artists learn more about mixing and mastering as they will be creating a
      song together in real time! If you have any questions or comments we hope
      you reach out to us so we can assist you as best as we can! And remember,
    ...
    <div id="error">
      <form action="https://formspree.io/f/xzbwaayo" method="POST">
        <div>
          <h3 class="fill">ENTER YOUR NAME</h3>
          <h3 class="fill">AND EMAIL SO WE CAN REACH OUT!</h3>
